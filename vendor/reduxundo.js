...
function updateState(state, history) {
  return wrapState(Object.assign({}, state, history));
}
// /updateState
...
function undoable(reducer) {
  ...
  var config = {
    ...
    undoType: rawConfig.undoType,
    redoType: rawConfig.redoType,
    jumpToPastType: rawConfig.jumpToPastType,
    jumpToFutureType: rawConfig.jumpToFutureType
  };
    ...
    switch (action.type) {
      ...
      default:
        ...
        if (config.initTypes.some(function (actionType) {
          ...
          debugEnd();
          return wrapState(Object.assign({}, state, createHistory(res)));
        }
        ...
        if (config.filter && typeof config.filter === 'function') {
          if (!config.filter(action, res, state && state.present)) {
            ...
            debugEnd();
            return wrapState(Object.assign({}, state, {
              present: res
            }));
          }
        }
        ...
        return wrapState(Object.assign({}, state, updatedHistory));
    }
  };
}
// /redux-undo
