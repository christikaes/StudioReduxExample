...
function save() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      namespace = _ref$namespace === undefined ? "redux_localstorage_simple" : _ref$namespace,
  ...
  return function (store) {
    return function (next) {
      return function (action) {
        ...
        if (!isArray(states)) {
          console.log("[Redux-LocalStorage-Simple]", '\'states\' parameter in \'save()\' method was passed a non-array value. Setting default value instead. Check your \'save()\' method.');
          states = [];
        }

        // Validate 'namespace' parameter
        if (!isString(namespace)) {
          console.log("[Redux-LocalStorage-Simple]", '\'namespace\' parameter in \'save()\' method was passed a non-string value. Setting default value instead. Check your \'save()\' method.');
          namespace = "redux_localstorage_simple";
        }

        // Validate 'debounce' parameter
        if (!isInteger(debounce)) {
          console.log("[Redux-LocalStorage-Simple]", '\'debounce\' parameter in \'save()\' method was passed a non-integer value. Setting default value instead. Check your \'save()\' method.');
          debounce = 0;
        }
...
function load() {
  var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      namespace = _ref2$namespace === undefined ? "redux_localstorage_simple" : _ref2$namespace;

  // Validate 'states' parameter
  if (!isArray(states)) {
    console.log("[Redux-LocalStorage-Simple]", '\'states\' parameter in \'load()\' method was passed a non-array value. Setting default value instead. Check your \'load()\' method.');
    states = [];
  }

  // Validate 'immutablejs' parameter
  if (!isBoolean(immutablejs)) {
    console.log("[Redux-LocalStorage-Simple]", '\'immutablejs\' parameter in \'load()\' method was passed a non-boolean value. Setting default value instead. Check your \'load()\' method.');
    immutablejs = false;
  }

  // Validate 'namespace' parameter
  if (!isString(namespace)) {
    console.log("[Redux-LocalStorage-Simple]", '\'namespace\' parameter in \'load()\' method was passed a non-string value. Setting default value instead. Check your \'load()\' method.');
    namespace = "redux_localstorage_simple";
  }
...
function combineLoads() {
  ...
  loads.forEach(function (load) {
    ...
    if (!isObject(load)) {
      console.error("[Redux-LocalStorage-Simple]", 'One or more loads provided to \'combineLoads()\' is not a valid object. Ignoring the invalid load/s. Check your \'combineLoads()\' method.');
      load = {};
    }
...
function clear() {
  var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      namespace = _ref3$namespace === undefined ? "redux_localstorage_simple" : _ref3$namespace;

  // Validate 'namespace' parameter
  if (!isString(namespace)) {
    console.error("[Redux-LocalStorage-Simple]", '\'namespace\' parameter in \'clear()\' method was passed a non-string value. Setting default value instead. Check your \'clear()\' method.');
    namespace = "redux_localstorage_simple";
  }
